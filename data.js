const SITE_DATA = {
  ...
  // ============================================================
  bio: [
    "I am a Ph.D. student in Economics at Wuhan University, China, and will expect to be on the job market in the 2026–2027 academic year. My research lies in environmental, labor, and development economics. Specifically, I mainly investigate two distinct topics: (i) water allocation along a river and its local responses (my Ph.D. dissertation), and (ii) human capital accumulation in developing countries.",
  ],
